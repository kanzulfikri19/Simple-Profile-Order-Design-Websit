...
if( isset($_POST["submit"]) ) {
    ...
    if( tambah($_POST) > 0){
        ...
        <script>
            ...
            document.location.href = 'pageinti_pesan.php';
        </script>
        ";
...
<h1 >PEMESANAN</h1>
    ...
    <form action="" method="post" enctype="multipart/form-data"  class="form-group tengah">
        <ul >
            ...
            <a style="color: white; background-color: #008CBA; font-size: 12px; border-radius: 8px; padding: 8px 22px; display: inline-block;" href="pageinti_pesan.php" class="previous">Kembali</a>
            </li>
        </ul>
    </form>
